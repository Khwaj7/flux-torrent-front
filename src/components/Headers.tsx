    ...
    return (
        <header
            ...
            <nav className="hidden md:flex gap-6 text-sm font-medium">
                <Link to="/" className="hover:text-white transition text-gray-300">Parcourir</Link>
                <Link to="/top-100" className="hover:text-white transition text-[var(--primary-accent)] font-bold">Top 100</Link>
                <Link to="/login" className="hover:text-white transition text-gray-300">Login</Link>
            </nav>
        </header>
    );
}